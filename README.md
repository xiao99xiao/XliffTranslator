...
- [Usage](#usage)
- [Working with Xcode Localizations](#working-with-xcode-localizations)
  - [Exporting XLIFF Files](#exporting-xliff-files)
  - [Importing Translated Files](#importing-translated-files)
- [Options](#options)
- [App Context Configuration](#app-context-configuration)
- [Translation Prompts](#translation-prompts)
- [Helper Scripts](#helper-scripts)
  - [Export Localizations](#export-localizations)
  - [Import Localizations](#import-localizations)
